      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-3">
          {topics.map((topic, index) => (
            <div key={topic.id} className="bg-gray-900 rounded-2xl overflow-hidden">
              <button
                onClick={() => loadProblems(topic.id)}
              ...
              {expanded === topic.id && problems[topic.id] && (
                <div className="border-t border-gray-800">
                  {problems[topic.id].map((problem: any) => (
                    <div key={problem.id} className="flex justify-between items-center px-6 py-3 border-b border-gray-800 last:border-0">
