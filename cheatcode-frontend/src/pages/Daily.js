...
function Daily() {
  ...
  Logout
    ...
    <button onClick={() => navigate('/roadmap')} className="fixed top-4 left-4 bg-gray-800 hover:bg-gray-700 text-gray-400 text-sm px-4 py-2 rounded-xl transition">
  Roadmap 🗺️
    </button>
        ...
        {/* Revision Question */}
        {session.revisionQuestion ? (<div className="bg-gray-900 rounded-2xl p-6 mb-6">
      ...
      {rating}
          ...
          </div>) : (<div className="bg-gray-900 rounded-2xl p-6 mb-6 text-gray-400">No revision due today 🎉</div>)}

        {/* Today's Topic */}
        {session.topicQuestion && (<div className="bg-gray-900 rounded-2xl p-6 mb-6">
  ...
  Mark as Solved ✅
        ...
        {/* Streak Protector */}
        {session.streakQuestion && (<div className="bg-gray-900 rounded-2xl p-6">
